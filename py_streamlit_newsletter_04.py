...
if not st.session_state.authenticated:
    ...
    with st.container():
        ...
        def display_metric_tables(df, metrics_list, title):
        ...
        display_metric_tables(league_and_position_data, offensive_metrics, "Offensive Metrics")
        display_metric_tables(league_and_position_data, defensive_metrics, "Defensive Metrics")
